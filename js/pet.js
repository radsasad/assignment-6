            ...
            <figure class="p-3">
                        ...
                        <div class="px-5 pb-4">
                            ...
                            <div class="flex justify-between mt-3 card-actions">
                                ...
                                <button class="px-4 py-1 text-base font-semibold rounded-md text-cyan-900 bg-slate-200">Details</button>
                            </div>
                        </div>
...
const displayCategory = (categories) => {
    categories.forEach((item) => {
        ...
        div.innerHTML = `
        <button onclick="loadCategoryPets('${category}')" class="flex items-center text-xl font-semibold btn" type="button"><img class="w-10 h-10"
